    ...
    try:
        ...
        if previous_query:
            ...
            if is_negative_about_matrix:
                ...
                if is_about_limits:
                    conversation_context = f"\n\nCONTEXTO CRÍTICO DE LA CONVERSACIÓN ANTERIOR:\n- El usuario PREGUNTÓ ANTERIORMENTE: \"{previous_query}\"\n- El TEMA DE LA PREGUNTA ANTERIOR era sobre: {previous_tema}\n- AHORA el usuario pregunta: \"{query}\"\n- Esta pregunta es sobre LOS LÍMITES (LOD/LOQ) de {previous_tema}.\n- DEBES buscar en las METODOLOGÍAS RELEVANTES ENCONTRADAS los valores de LOD y LOQ para {previous_tema}.\n- RESPUESTA OBLIGATORIA: Si encuentras LOD/LOQ en el contexto para {previous_tema}, responde con esos valores específicos. Ejemplo: 'El LOD para {previous_tema} es [valor] y el LOQ es [valor]'.\n- Si NO encuentras los valores de LOD/LOQ en el contexto, responde: 'No encontré información específica sobre los límites de detección y cuantificación para {previous_tema} en el contexto. Te recomiendo contactarnos al email farmavet@uchile.cl para más información.'\n- NO inventes valores, usa SOLO lo que está EXPLÍCITAMENTE en las METODOLOGÍAS RELEVANTES ENCONTRADAS."
                else:
