...
class MetodologiasChatbot {
    ...
    async sendMessage() {
        ...
        setTimeout(async () => {
            ...
            const needsReasoning = /\b(por que|porque|como funciona|que significa|explique|diferencia|comparar|recomendar|sugerir|limite|limites|lod|loq|cual es|cuales son)\b/i.test(query);
